...
describe("Testing Products DAO", () => {
    ...
    it("El DAO debe obtener los productos con paginación, utilizando las opciones que se mandan por parámetros", async function() {
        const result = await this.productsDao.getPaginate({categories: "criptomoneda"}, {limit: 5, page: 2, sort: {}, lean: true})
    ...
    it("El DAO debe poder crear un nuevo producto", async function() {
        const product = {
            title: "Bitcoin",
            description: "Criptomoneda de emision descentralizada",
            lang: "es",
            code: "NHS456",
            price: 30000,
            stock: 10,
